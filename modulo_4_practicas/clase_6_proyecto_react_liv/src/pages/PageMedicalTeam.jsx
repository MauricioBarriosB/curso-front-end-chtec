...
function PageMedicalTeam() {
  ...
  const [loadProfilesView, setLoadProfilesView] = useState(false);

  // * Set lazy load ProfileView component on button click demand (loadProfilesView = true) :
      ...
      <div className='container pt-4 pb-2'>
        ...
        <div className='container marketing'>
          ...
          <div className="text-center pt-4">
            <button className="btn btn-primary" onClick={()=>setLoadProfilesView(true)}>
              Cargar Vista Administración de Perfiles de Usuario
            </button>
          </div>
          )}
