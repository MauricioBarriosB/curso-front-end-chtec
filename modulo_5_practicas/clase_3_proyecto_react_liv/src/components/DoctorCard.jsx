...
function DoctorCard({ fname, lname, photo, specialty_name, experience, biography, onOpen }) {

  const handleOnClick = (e) => {
    console.log("* Button Clicked :", e.target.dataset.label);
    onOpen(fname, lname, photo, specialty_name, experience, biography);
  };
    ...
    <div className="col-lg-4">
      <div className="card dmx-auto">
        ...
        <div className="card-body">
          ...
          <p className="card-text">Especialidad: {specialty_name}</p>
